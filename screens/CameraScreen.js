...
export default function CameraScreen({ route, navigation, ttsVolume }) {
  ...
  const speakDescription = (description) => {
    ...
    if (ttsVolume === 0.0) {
      ...
      Speech.speak(description, {
        ...
        pitch: 1.0,
        rate: 1.0,
        volume: ttsVolume, // Use the passed TTS volume state
      });
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.backButtonContainer}>
          <TouchableOpacity onPress={() => {Speech.stop(); navigation.navigate('Land Pollution')}}>
            <Image
