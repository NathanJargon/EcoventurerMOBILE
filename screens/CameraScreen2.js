...
export default function CameraScreen2({ route, navigation, ttsVolume }) {
  ...
  const handleMinigame = async () => {
    ...
    navigation.navigate('Minigame', { 
      level: currentLevel,
      levelName: 'Recycling Wastes' // Add the levelName parameter here
    });
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.backButtonContainer}>
          <TouchableOpacity onPress={() => {Speech.stop(); navigation.navigate('Recycling Wastes')}}>
            <Image
